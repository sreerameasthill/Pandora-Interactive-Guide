...
import {
  require_jsx_runtime
} from "./chunk-A4XIW7VS.js";
import {
  require_react_dom
} from "./chunk-MVWPOKMQ.js";
import {
  require_react
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React3 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = shim.useSyncExternalStore, useRef7 = React3.useRef, useEffect7 = React3.useEffect, useMemo4 = React3.useMemo, useDebugValue = React3.useDebugValue;
...
function parseSegments(defaultCaseSensitive, data, route, start, node, depth, onRoute) {
  ...
  let cursor = start;
  {
    ...
    const parseParams = ((_c = (_b = route.options) == null ? void 0 : _b.params) == null ? void 0 : _c.parse) ?? ((_d = route.options) == null ? void 0 : _d.parseParams);
    while (cursor < length) {
      ...
      switch (segment[0]) {
        case 0: {
          ...
          if (caseSensitive) {
            const existingNode = (_e = node.static) == null ? void 0 : _e.get(value);
            ...
            const existingNode = (_f = node.staticInsensitive) == null ? void 0 : _f.get(name);
            if (existingNode) nextNode = existingNode;
            else {
        ...
        case 1: {
          ...
          const existingNode = !parseParams && ((_g = node.dynamic) == null ? void 0 : _g.find((s) => !s.parse && s.caseSensitive === actuallyCaseSensitive && s.prefix === prefix && s.suffix === suffix));
          if (existingNode) nextNode = existingNode;
          else {
        ...
        case 3: {
          ...
          const prefix = !prefix_raw ? void 0 : actuallyCaseSensitive ? prefix_raw : prefix_raw.toLowerCase();
          const suffix = !suffix_raw ? void 0 : actuallyCaseSensitive ? suffix_raw : suffix_raw.toLowerCase();
          const existingNode = !parseParams && ((_h = node.optional) == null ? void 0 : _h.find((s) => !s.parse && s.caseSensitive === actuallyCaseSensitive && s.prefix === prefix && s.suffix === suffix));
          if (existingNode) nextNode = existingNode;
          else {
    ...
    node.priority = ((_j = (_i = route.options) == null ? void 0 : _i.params) == null ? void 0 : _j.priority) ?? 0;
...
function createScrollRestorationCache() {
  try {
    return JSON.parse((safeSessionStorage == null ? void 0 : safeSessionStorage.getItem("tsr-scroll-restoration-v1_3")) || "{}");
  } catch {
    return {};
  }
}
function persistScrollRestorationCache() {
  try {
    safeSessionStorage == null ? void 0 : safeSessionStorage.setItem(storageKey, JSON.stringify(scrollRestorationCache));
  } catch {
...
function setupScrollRestoration(router, force) {
  ...
  const snapshotCurrentScrollTargets = (restoreKey) => {
    const keyEntry = scrollRestorationCache[restoreKey] || (scrollRestorationCache[restoreKey] = {});
  ...
  router.subscribe("onRendered", (event) => {
        ...
        for (const elementSelector in fromElementEntries) {
          if (elementSelector === windowScrollTarget) {
            ...
            if (shouldResetScroll && scrollToTopSelectors) {
              scrollToTopElements ?? (scrollToTopElements = getScrollToTopElements(scrollToTopSelectors));
              if (scrollToTopElements.has(element)) continue;
            }
          }
          if (!toElementEntries) toElementEntries = scrollRestorationCache[cacheKey] = {};
          toElementEntries[elementSelector] ?? (toElementEntries[elementSelector] = fromElementEntries[elementSelector]);
        }
      }
    }
    ignoreScroll = true;
    try {
      ...
      if (shouldResetScroll) {
        if (!hash && scrollToTopSelectors) scrollToTopElements ?? (scrollToTopElements = getScrollToTopElements(scrollToTopSelectors));
        ...
        if (elementEntries) for (const elementSelector in elementEntries) {
          ...
          if (elementSelector === windowScrollTarget) {
            ...
            if (element) {
              ...
              scrollToTopElements == null ? void 0 : scrollToTopElements.delete(element);
            }
          }
        }
        if (!hash) {
      ...
      if (!windowRestored && hash && hashScrollIntoViewOptions) (_a = document.getElementById(hash)) == null ? void 0 : _a.scrollIntoView(hashScrollIntoViewOptions);
    } finally {
      ignoreScroll = false;
    }
  });
  ...
  constructor(options, getStoreConfig) {
    ...
    this.buildLocation = (opts) => {
      const build = (dest = {}) => {
        ...
        const sourcePath = (destTo == null ? void 0 : destTo.charCodeAt(0)) === 47 ? "/" : this.resolvePathWithBase(defaultedFromPath, ".");
                ...
                this.startTransition(() => {
                  this.startViewTransition(async () => {
                    ...
                    for (const [matches, hook] of [
                      ...
                      if (!matches) continue;
                      for (const match of matches) (_b = (_a3 = this.looseRoutesById[match.routeId].options)[hook]) == null ? void 0 : _b.call(_a3, match);
                    }
                  });
                });
              }
...
function buildMiddlewareChain(destRoutes) {
  ...
  for (const route of destRoutes) {
    ...
    if ("search" in routeOptions) {
      if ((_a = routeOptions.search) == null ? void 0 : _a.middlewares) middlewares.push(...routeOptions.search.middlewares);
...
function getManifestScriptFormat(manifest) {
  return (manifest == null ? void 0 : manifest.scriptFormat) ?? "module";
}
...
function retainSearchParams(keys) {
  return ({ search, next }) => {
    ...
    if (keys === true) {
      ...
      for (const key of (removed == null ? void 0 : removed.keys()) || []) if (explicit2 && hasOwn.call(explicit2, key) || deepEqual(search[key], removed.get(key))) delete copy2[key];
      for (const key of meta.removedAny || []) delete copy2[key];
      for (const key of ((_a = meta.defaulted) == null ? void 0 : _a.keys()) || []) if (key in search && !((_b = meta.removedAny) == null ? void 0 : _b.has(key)) && !(((_c = meta.removed) == null ? void 0 : _c.has(key)) && (explicit2 && hasOwn.call(explicit2, key) || deepEqual(search[key], meta.removed.get(key))))) copy2[key] = search[key];
      return copy2;
    }
    ...
    for (const key of keys) {
      const stringKey = key;
      if (!(((_d = meta.removedAny) == null ? void 0 : _d.has(stringKey)) || ((_e = meta.removed) == null ? void 0 : _e.has(stringKey)) && (explicit && hasOwn.call(explicit, stringKey) || deepEqual(search[key], meta.removed.get(stringKey)))) && (!(key in copy) || key in search && ((_f = meta.defaulted) == null ? void 0 : _f.has(stringKey)) && deepEqual(copy[key], meta.defaulted.get(stringKey)))) copy[key] = search[key];
    }
    return copy;
  };
}
  ...
  return (({ search, next, meta }) => {
    if (input === true) {
      Object.keys(search).forEach((key) => {
        if (meta) (meta.removedAny || (meta.removedAny = /* @__PURE__ */ new Set())).add(key);
      });
      return {};
    }
    const result = { ...next(search) };
    if (Array.isArray(input)) input.forEach((key) => {
      ...
      if (deepEqual(result[key], value)) {
        delete result[key];
        if (meta) (meta.removed || (meta.removed = /* @__PURE__ */ new Map())).set(key, value);
      }
    });
    return result;
  });
...
// node_modules/seroval/dist/index.js
...
// node_modules/seroval-plugins/dist/rolldown-runtime-D7D4PA-g.js
...
// node_modules/seroval-plugins/dist/web-43VA2W_p.js
...
function useStructuralSharing(opts, router) {
  ...
  return (slice) => {
    ...
    if ((opts == null ? void 0 : opts.structuralSharing) ?? router.options.defaultStructuralSharing) return previousResult.current = replaceEqualDeep(previousResult.current, selected);
    return selected;
  };
}
...
function MatchView({ router, matchId, resetKey, matchState }) {
  ...
  }), matchState.parentRouteId === rootRouteId ? (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [(0, import_jsx_runtime11.jsx)(OnRendered, {}), router.options.scrollRestoration && (isServer ?? router.isServer) ? (0, import_jsx_runtime11.jsx)(ScrollRestoration, {}) : null] }) : null] });
}
function OnRendered() {
  const router = useRouter();
  if (isServer ?? router.isServer) return null;
  const prevResolvedLocationRef = React$111.useRef();
  useLayoutEffect2(() => {
  ...
  }, [useStore(router.stores.resolvedLocation, (resolvedLocation) => resolvedLocation == null ? void 0 : resolvedLocation.state.__TSR_key), router]);
  return null;
}
...
var Outlet = React$111.memo(function OutletImpl() {
  ...
  if (isServer ?? router.isServer) {
    ...
    [routeId, parentGlobalNotFound] = useStore(parentMatchStore, (match) => [match == null ? void 0 : match.routeId, (match == null ? void 0 : match.globalNotFound) ?? false], outletMatchSelectionEqual);
...
function InlineCssStyle({ attrs, children, nonce }) {
  ...
  const [hydratedInlineCss] = React$115.useState(() => {
    ...
    return ((_a = document.querySelector(`style[${INLINE_CSS_HYDRATION_ATTR}]`)) == null ? void 0 : _a.textContent) ?? void 0;
  });
...
function buildTagsFromMatches(router, nonce, matches, assetCrossOrigin) {
  ...
  if (manifest) {
    matches.forEach((match) => {
      var _a2, _b;
      (_b = (_a2 = manifest.routes[match.routeId]) == null ? void 0 : _a2.css) == null ? void 0 : _b.forEach((link2) => {
  ...
  if (manifest) matches.forEach((match) => {
    var _a2, _b;
    (_b = (_a2 = manifest.routes[match.routeId]) == null ? void 0 : _a2.preloads) == null ? void 0 : _b.forEach((preload) => {
      preloadLinks.push({
        tag: "link",
        attrs: {
...
var useTags = (assetCrossOrigin) => {
  ...
  const manifestCssTags = useStore(router.stores.matches, (matches) => {
    ...
    matches.forEach((match) => {
      var _a3, _b;
      (_b = (_a3 = manifest.routes[match.routeId]) == null ? void 0 : _a3.css) == null ? void 0 : _b.forEach((link2) => {
        const resolvedLink = resolveManifestCssLink(link2);
        tags2.push({
          tag: "link",
          attrs: {
  ...
  const preloadLinks = useStore(router.stores.matches, (matches) => {
    ...
    matches.forEach((match) => {
      var _a3, _b;
      (_b = (_a3 = manifest.routes[match.routeId]) == null ? void 0 : _a3.preloads) == null ? void 0 : _b.forEach((preload) => {
        preloadLinks2.push({
          tag: "link",
          attrs: {
            ...getScriptPreloadAttrs(manifest, preload, assetCrossOrigin),
...
var Scripts = () => {
  ...
  const getAssetScripts = (matches) => {
    ...
    for (const match of matches) {
      const scripts = (_b = manifest.routes[match.routeId]) == null ? void 0 : _b.scripts;
      if (!scripts) continue;
      for (const asset of scripts) assetScripts2.push({
        ...
        ...typeof ((_c = asset.attrs) == null ? void 0 : _c.src) === "string" ? { preventScriptHoist: true } : {}
      });
    }
...
function renderScripts(router, scripts, assetScripts) {
  ...
  return (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, { children: allScripts.map((asset, i) => (0, import_react8.createElement)(Asset, {
    ...asset,
...
function HeadContent2(props) {
  ...
  return (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: (hydrated ? tags.filter((tag) => {
    var _a2;
    return tag.tag !== "link" || ((_a2 = tag.attrs) == null ? void 0 : _a2[DEV_STYLES_ATTR]) !== true;
  }) : tags).map((tag) => (0, import_react10.createElement)(Asset, {
    ...tag,
